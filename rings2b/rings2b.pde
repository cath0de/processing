...
public void setup() {
  ...
  tube2 = new Tube(this, 4, 50);
  tube2.setSize(40, 40, 40, 40, 16);
  tube2.drawMode(S3D.SOLID);
  tube2.fill(color(0,127,127));
  tube2.rotateToX(1.5708);
  tube2.visible(false,S3D.BOTH_CAP);
  //tube2.fill(color(0,127,64),S3D.BOTH_CAP);
  //tube2.strokeWeight(10);
}
