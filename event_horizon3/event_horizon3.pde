...
WB_Circle circle;
SpikyRing spiky_ring, ring2, ring3;
Sphere c_sphere;
PVector rotation;
...
void setup() {
  ...
  ring2 = new SpikyRing(190, 30, 80, 0);
  ring3 = new SpikyRing(150, 30, 80, 0);
  c_sphere = new Sphere(110);
}
...
void draw() {
  ...
  ring2.display(rotation);
  rotation = new PVector(0, 0, R_z);
  ring3.display(rotation);
  rotation = new PVector(R_x, R_y, R_z);
  c_sphere.display(rotation);
}
